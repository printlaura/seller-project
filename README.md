...
The target users of this Flask application are the Brand Managers (employees of Seller Project who are in charge of each of the brands' business decisions). Once fully developed, this tool should serve them for analytics, reporting and brand data management purposes.
